...
Notifications.configure = function(options: Object) {
	...
	if ( this.isLoaded === false ) {
		...
		this._onErrorNotification = this._onErrorNotification.bind(this);
...
Notifications._onErrorNotification = function(error) {
	if (this.onError) {
		this.onError(error);
	}
}
...
Notifications.setAndroidNotificationsEnabled = function() {
	// Only available for Android
	return this.callNative('setAndroidNotificationsEnabled', arguments)
}
